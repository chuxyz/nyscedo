...
<div style="float:left; position:absolute; bottom:5px; left:200px; font-size:16px;"><a href="<?php echo base_url(); ?>"><button>Cancel/Home</button></a><a href="<?php echo base_url('undopayment'); ?>"><button disabled="disabled">Undo Payment</button></a><a href="<?php echo base_url('payment'); ?>"><button>Payment</button></a></div>
</div>
<div id="body1" style="margin-top:20px;">
<h2 align="center" style="color:#F00;">Undo Payments</h2>
  <form action="" method="post" enctype="multipart/form-data" name="form1" id="serial">
	...
	?>
      ...
      <option value="dec">December</option>
        ...
        <td><input name="payment" type="submit" value="Undo Payment" /></td>
      </tr>
    </table>
  </form>
</div>